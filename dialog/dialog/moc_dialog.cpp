...
QT_MOC_LITERAL(4, 21, 19),
QT_MOC_LITERAL(5, 41, 2),
QT_MOC_LITERAL(6, 44, 12),
QT_MOC_LITERAL(7, 57, 9),
QT_MOC_LITERAL(8, 67, 16),
QT_MOC_LITERAL(9, 84, 4)
    },
    "Dialog\0findNext\0\0str\0Qt::CaseSensitivity\0"
    "cs\0findPrevious\0findClick\0enablefindButton\0"
    "text\0"
};
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Dialog::*_t)(const QString & , Qt::CaseSensitivity );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Dialog::findNext)) {
                *result = 0;
            }
        }
        {
            typedef void (Dialog::*_t)(const QString & , Qt::CaseSensitivity );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Dialog::findPrevious)) {
                *result = 1;
            }
        }
    }
